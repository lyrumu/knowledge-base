...
![p1](image/docker-Dify/启用或关闭windows功能.png)
...
![p](image/docker-Dify/dify依赖镜像下载完成.png)
...
![p](image/docker-Dify/dify-ollama供应商.png)

安装完成后点击上图右下角-添加模型;

![p](image/docker-Dify/dify连接本地大模型.png)
