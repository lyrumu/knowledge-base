...
1. [两种修改方式](PatPat-资源包制作指南.md#两种修改方式)
2. [PatPat 模组资产结构](PatPat-资源包制作指南.md#patpat-模组资产结构)
3. [前置条件](PatPat-资源包制作指南.md#前置条件)
4. [方式 A：替换默认动画（简单）](PatPat-资源包制作指南.md#方式-a替换默认动画)
   - [A1. 确定 pack_format](PatPat-资源包制作指南.md#a1-确定-pack_format)
   - [A2. 处理纹理](PatPat-资源包制作指南.md#a2-处理纹理)
   - [A3. 处理音效](PatPat-资源包制作指南.md#a3-处理音效)
   - [A4. 编写 pack.mcmeta](PatPat-资源包制作指南.md#a4-编写-packmcmeta)
   - [A5. 打包 ZIP](PatPat-资源包制作指南.md#a5-打包-zip)
5. [方式 B：自定义动画配置（高级）](PatPat-资源包制作指南.md#方式-b自定义动画配置)
   - [B1. 动画配置文件格式](PatPat-资源包制作指南.md#b1-动画配置文件格式)
   - [B2. 配置字段详解](PatPat-资源包制作指南.md#b2-配置字段详解)
   - [B3. 优先级系统](PatPat-资源包制作指南.md#b3-优先级系统)
   - [B4. 自定义音效注册](PatPat-资源包制作指南.md#b4-自定义音效注册)
   - [B5. 完整示例](PatPat-资源包制作指南.md#b5-完整示例)
6. [获取原版 Minecraft 素材](PatPat-资源包制作指南.md#获取原版-minecraft-素材)
7. [官方模板资源包](PatPat-资源包制作指南.md#官方模板资源包)
8. [常见踩坑](PatPat-资源包制作指南.md#常见踩坑)
9. [参考链接](PatPat-资源包制作指南.md#参考链接)
